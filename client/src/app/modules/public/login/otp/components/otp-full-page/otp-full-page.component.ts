...
@Component({
  selector: 'otp-full-page',
  templateUrl: './otp-full-page.component.html',
  styleUrls: ['./otp-full-page.component.scss'],
})
export class OtpFullPageComponent extends Unsub implements OnInit {
